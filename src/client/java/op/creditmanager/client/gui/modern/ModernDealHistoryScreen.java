...
public final class ModernDealHistoryScreen extends ModernBaseScreen {
    ...
    @Override public boolean mouseClicked(Click click, boolean doubled) {
        ...
        if (click.button() == 0 && queryError != null && errorButtons.size() == 2 && ModernUi.contains(click.x(), click.y(), errorButtons.get(1).x(), errorButtons.get(1).y(), errorButtons.get(1).width(), errorButtons.get(1).height())) { queryError = null; forceSearch = true; debouncer.commitImmediately(rawSearchKey); return true; }
